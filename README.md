...
> **Note:** In order to use Jacoco for code coverage [Oracle JDK 8](https://www.oracle.com/java/technologies/javase-jdk8-downloads.html) `oraclejdk8` is required. [#](https://github.com/codecov/example-java-maven/pull/11)
